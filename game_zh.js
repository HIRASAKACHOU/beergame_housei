...
function updateMainUI() {
    ...
    document.getElementById('orderSectionTitle').textContent = isFactory ? '🏭 生产区' : '📝 订货区';
    document.getElementById('orderInputLabel').textContent = isFactory ? '生产数量:' : '订货数量:';
    document.querySelector('.order-btn').textContent = isFactory ? '✓ 确认生产' : '✓ 确认订货';
